...
/*   Updated: 2025/07/15 17:41:14 by mohaben-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes_bonus/minirt_bonus.h"

static void	set_texture_type(t_plane *pl, int arg_count, char *str)
{
	if (arg_count == 5)
	{
		...
		else
		{
			...
			pl->material.texture = load_texture(str);
		}
	}
	else
...
void	parse_plane(char *input, t_object_list *scene, t_rt *rt, int *id)
{
	...
	set_texture_type(pl, arg_count, splited[4]);
